    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap">
            <div class="w-full lg:w-6/12 px-4">
                ...
                <div class="mt-3">
                    <p class="leading-relaxed mt-1 mb-1 text-gray-600">{{ $addr }}</p>
                    <p class="leading-relaxed mt-1 mb-1 text-gray-600">{{ $tel }}</p>
                    <p class="leading-relaxed mt-1 mb-1 text-gray-600">{{ $mail }}</p>
                    <button
